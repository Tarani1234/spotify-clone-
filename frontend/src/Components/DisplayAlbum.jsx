...
function DisplayAlbum() {
    ...
    const albumData = albumsData[id];  // If albumsData is an object
console.log('Album Data:', albumData);  // Log the album data to verify
    ...
    <div className='mt-10 flex gap-8 flex-col md:flex-row md:items-end'>
      <img className='w-48 rounded' src={albumData.image} alt=''/>
        <div className='flex flex-col'>
          ...
          <p className='mt-1'>
            <img className='inline-block w-5 mr-4' src={assets.spotify_logo} alt=''/>
     ...
     <div className='grid grid-cols-3 sm:grid-cols-4 mb-4 pl-2 mt-10 text-[#a7a7a7]'>
       ...
       <img className='m-auto w-8' src={assets.clock_icon}alt=''/>
     </div>
     <hr/>
     {
